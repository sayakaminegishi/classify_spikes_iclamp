...
% second attempt using less variables as a classifier
...
%0.4259 rloss: commonVars = {'APAmplitude_mV_', 'APThreshold_mV_','APWidth_ms_', 'Age_postnatalDays_', 'InputResistance_M__', 'ReboundAPs_number_'};
